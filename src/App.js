            ...
            >
              ...
              <div style={{width: '28%'}}>
                <Card style={{padding: 20}}>
                  ...
                  <CardText>
                    ...
                    <p>
                      <Linkify>https://careers.jpmorgan.com/careers/US/en/programs?type=Full-Time - JP Morgan Chase & Co Post Graduate Opportunities</Linkify>
                    </p>
                    <p>
                      <Linkify>https://careers.blizzard.com/en-us/openings/all/all/all/new-grad-roles/1 - Blizzard Entertainment Post Graduate Opportunities</Linkify>
                    </p>
                    <p>
                      <Linkify>https://www.redhat.com/en/jobs/categories/technology - RedHat Post Graduate Opportunities</Linkify>
                    </p>
                    <p>
                      <Linkify>
              ...
              <div style={{width: '28%'}}>
                <Card style={{padding: 20}}>
                  ...
                  />
                  <CardText>
                    <h2>Ada Lovelace - 1815-1852; The Prophet of the Computer Age</h2>
                    <p>
                      <Linkify>Ada is considered to be the first computer programmer. She translated and extended onto article on Babbage's analytical engine that was published in 1843, however its significance was not recognized until after her death.  </Linkify>
                    </p>
                    <h2>Rear Admiral Grace Hopper - 1906-1992 (Pictured Above)</h2>
                    <p>
                      <Linkify>Grace created the first compiler for computer languages, which renders worded instructions into code that can be read by computers. She joined the US Navy in 1943, joined the reserves after WWII, retired in 1966, and then returned in 1967 and served another 19 years before officially retiring in 1986. Grace was awarded the National Medal of Technology in 1991—becoming the first female individual recipient of the honor.</Linkify>
                    </p>
                    <h2>Katherine Johnson, Dorothy Vaughan, and Mary Jackson</h2>
                    <p>
                      <Linkify>Katherine, Dorothy, and Mary were all involved in John Glenn's trip around the globe in 1962. Katherine calculated the trajectories needed for a save takeoff and splashdown for the trip. Dorothy became the National Advisory Committee for Aeronautics's first black computing supervisor as well as their first expert FORTAN programmer. Mary was original assisting Kazimierz Czarnecki in aeronautic research engineering before petitioning & winning the right to take engineering courses at Hampton High School, which was at the time segregated. She then became NASA's first female African-American engineer.</Linkify>
                    </p>
                  </CardText>
